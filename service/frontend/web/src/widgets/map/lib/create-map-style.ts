export const createMapStyle = () => {
  return {
    ...
    sources: {
      ...
      ofmaps_planet: {
        type: 'vector',
        tiles: ['https://tiles.ofmaps.ru/tiles/{z}/{x}/{y}.pbf'],
        minzoom: 0,
        maxzoom: 14,
      },
    },
    layers: [
      ...
      },
      {
        ...
        paint: {
          ...
          'line-width': [
            ...
            ['zoom'],
            13,
            ['match', ['get', 'class'], ['trunk', 'primary'], 5, 8],
            15,
            ['match', ['get', 'class'], ['trunk', 'primary'], 15, 22],
            17,
            ['match', ['get', 'class'], ['trunk', 'primary'], 20, 24],
          ],
        },
        filter: [
          'all',
      ...
      },
      {
        ...
        paint: {
          ...
          'fill-extrusion-height': [
            'case',
            // ['==', ['id'], 2459854], // OSM id нужного здания
            [
              'any',
              ['==', ['id'], 156217653],
              ['==', ['id'], 871173],
            ...
            0, // делаем его плоским
            ['get', 'render_height'], // остальные — как обычно
          ],
          'fill-extrusion-color': [
            'case',
            ['==', ['id'], 2459854], // OSM id нужного здания
            'hsl(44,14%,79%)', // делаем его плоским
            'hsl(44,14%,79%)', // остальные — как обычно
          ],
      ...
      },
      {
        ...
        layout: {
          ...
          'symbol-placement': 'line',
          'symbol-spacing': ['step', ['zoom'], 250, 21, 1000],
    ...
    glyphs:
      'https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=m3AyvP3IhyUhNfKKultZ',
